...
export const filterProductValidator = () => [
  body("search", "Please provide a name of filter product").notEmpty(),
  body("company", "Please provide a company of filter product").notEmpty(),
  body("category", "Please provide a category of filter product").notEmpty(),
  body("price", "Please provide a price of filter product").notEmpty(),
  body(
    "shipping",
...
export const createOrderValidator = () => [
    ...
    body("cartItems", "Please provide a order cartItems").notEmpty().isArray({min: 1}).withMessage("Please provide 1 product to make a order"),
